...
var folderButtons = document.querySelectorAll(".gallery-type");
...
folderButtons.forEach(function(button) {
  button.addEventListener("click", function() {
    ...
    // show only grid items with selected folder
...
////// Make Mobile Navigation to Work
...
/////// Scroll back to top
    ...
    if (href === "#") window.scrollTo({
      top: 0, ///0 beacuse it takes me to the top.
      behavior: 'smooth',
    })
